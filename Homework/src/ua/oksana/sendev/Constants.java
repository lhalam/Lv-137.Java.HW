...
public class Constants {
	...
	public static final String[] TASK_108 = { "Дано натуральне число n. Отримати найменше число виду 2^r, більше за n." };
	public static final String[] TASK_331 = {
			"Дано натуральне число n. Чи можна подати його в вигляді суми квадратів трьох натуральних чисел?",
			"Якщо можна, то: ",
